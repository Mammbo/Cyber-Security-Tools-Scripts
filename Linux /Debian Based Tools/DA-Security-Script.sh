...
function menu {
	...
	echo ' 24) Delete Unauthorized Software'
	echo ' 25) Check Perms for Important Files'
	echo ' 26) Clear /etc/rc.local'
	echo ' 27) List all Running Services'
	echo ' 28) Run RKHunter'
	echo ' 29) Run ClamAV'
	echo ' 30) Run Chkroot'
	echo
	echo '99) Exit Script'
